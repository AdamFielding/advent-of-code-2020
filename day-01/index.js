...
const findMatchingEntry = (testEntry, entries) => entries.find((entry) => testEntry + entry === desiredResult) ?? null;
const [_, matchedEntries] = inputEntries.reduce(([prevEntries, prevMatched], entry) => {
